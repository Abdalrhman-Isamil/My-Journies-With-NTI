...
//     $age= $_POST['age'];
//     $errors=[];
//     if(strlen($usernam)<6 || strlen($usernam)>12 ){
//         $errors[]= "the username should be between 6 and 12 char";
//     }
//     if(strlen($password)<6 || strlen($password)>12 ){
//         $errors[]= "the password should be between 6 and 12 char";
//     }
//     if(strlen($age)<=16 || strlen($age)>=60 ){
//         $errors[]= "the username should be between 16 and 60 char";
//     }
//     if($errors){
